"""
OctahedralState: Core geometric state representation.

Ported from Geometric-to-Binary-Computational-Bridge/GEIS/octahedral_state.py
for use in PatternBridge's pattern encoding pipeline.

Represents a single octahedral coordination state with:
